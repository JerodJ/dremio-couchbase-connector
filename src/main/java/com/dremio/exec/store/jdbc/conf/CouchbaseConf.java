...
@SourceType(value = "CouchbaseARP", label = "Couchbase",uiConfig = "couchbase-layout.json")
public class CouchbaseConf extends AbstractArpConf<CouchbaseConf> {
  private static final String ARP_FILENAME = "arp/implementation/couchbase-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.couchbase.CouchbaseDriver";
