...
3. Download and install the [Couchbase JDBC Driver from CData](https://www.cdata.com/drivers/couchbase/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
